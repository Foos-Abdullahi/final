              ...
              <Table>
                <TableHead>
                  <TableRow>
                    <TableCell style={{ width: "1%" }}><Typography variant="body1" color="white">#</Typography></TableCell>
                    <TableCell><Typography variant="body1" color="white">Payment Method</Typography></TableCell>
                    <TableCell style={{  width:'10%' }} align="center"><Typography variant="body1" color="white">Amount</Typography></TableCell>
                    <TableCell style={{ width: "10%",mr:'5px'}} align="center"><Typography variant="body1" color="white">Date</Typography></TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {invoices.map((invoice, cl) => {
                    ...
                    return (
                      <TableRow key={cl} >
                        ...
                        <TableCell align="center"><Typography variant="body1" color="white">{invoice.issue_date}</Typography></TableCell>
                      </TableRow>
                    );
                  })}
                </TableBody>
                <TableFooter>
                  <TableRow>
                    <TableCell colSpan={2} align="right"><Typography variant="body1" color='#ffffff'>Total:</Typography></TableCell>
