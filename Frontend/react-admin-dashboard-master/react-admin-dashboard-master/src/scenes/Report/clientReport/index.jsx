...
//                 <Box>
//                   <Typography variant="h3" color="black">Company</Typography>
//                   <address>
//                     Street Address<br />
//                     State, City<br />
...
//                 <TableHead>
//                   <TableRow>
//                     <TableCell style={{ width: "1%" }}><Typography variant="body1" color="black">#</Typography></TableCell>
//                     <TableCell><Typography variant="body1" color="black">Payment Method</Typography></TableCell>
//                     <TableCell style={{  width:'10%' }} align="center"><Typography variant="body1" color="black">Amount</Typography></TableCell>
//                     <TableCell style={{ width: "10%",mr:'5px'}} align="center"><Typography variant="body1" color="black">Date</Typography></TableCell>
//                   </TableRow>
//                 </TableHead>
//                 <TableBody>
...
//                     return (
//                       <TableRow key={cl} >
//                         <TableCell ><Typography variant="body1" color="black">{cl + 1}</Typography></TableCell>
//                         <TableCell>
//                         <img src={`/assets/payment-method/${paymentMethod.pay_method_image}`} alt="Payment Method" style={{ width: 50, height: 50 }} /></TableCell>
//                         <TableCell align="center"><Typography variant="body1" color='black'>$ {invoice.amount}</Typography></TableCell>
//                         <TableCell align="center"><Typography variant="body1" color="black">{invoice.issue_date}</Typography></TableCell>
//                       </TableRow>
//                     );
//                   })}
//                 </TableBody>
