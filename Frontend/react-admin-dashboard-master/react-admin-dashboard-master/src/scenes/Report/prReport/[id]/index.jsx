      ...
      <Paper ref={printContentRef} elevation={3} sx={{ padding: "20px", color: "#4CCEA9", bgcolor: "#2C3744" }}>
        <Box>
          ...
          <Box display="flex" justifyContent="space-between" alignItems="flex-start">
            ...
            <Box>
              <Typography variant="h3" color="#4CCEA9">Project Details</Typography>
              <Typography variant="body1" color="#4CCEA9">Project Name: {project.project_name}</Typography>
              <Typography variant="body1" color="#4CCEA9">Start Date: {project.start_date}</Typography>
              <Typography variant="body1" color="#4CCEA9">End Date: {project.end_date}</Typography>
            </Box>
          </Box>
          <TableContainer>
            <Table>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell><Typography variant="body1" color="#4CCEA9">Material Name</Typography></TableCell>
                  <TableCell><Typography variant="body1" color="#4CCEA9">Quantity</Typography></TableCell>
                  <TableCell><Typography variant="body1" color="#4CCEA9">Sub Total</Typography></TableCell>
                  <TableCell align="right"><Typography variant="body1" color="#4CCEA9">Date</Typography></TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                {materials.map((material, index) => (
                  <TableRow key={material.id}>
                    <TableCell><Typography variant="body1" color="#4CCEA9">{index + 1}</Typography></TableCell>
                    <TableCell><Typography variant="body1" color="#4CCEA9">{material.material_name}</Typography></TableCell>
                    <TableCell><Typography variant="body1" color="#4CCEA9">{material.quantity}</Typography></TableCell>
                    <TableCell><Typography variant="body1" color="#4CCEA9">{material.sub_total}</Typography></TableCell>
                    <TableCell align="right"><Typography variant="body1" color="#4CCEA9">{material.issue_date}</Typography></TableCell>
                  </TableRow>
                ))}
              </TableBody>
              <TableFooter>
                <TableRow>
                  ...
                  <TableCell align="center"><Typography variant="body1" color="#4CCEA9">{total}</Typography></TableCell>
                  <TableCell></TableCell>
                </TableRow>
              </TableFooter>
            </Table>
          </TableContainer>
          <Typography variant="h3" color="#4CCEA9" mt={3}>Tasks</Typography>
          <TableContainer>
            <Table>
              <TableHead>
                <TableRow>
                  <TableCell><Typography variant="body1" color="#4CCEA9">Task Name</Typography></TableCell>
                  <TableCell><Typography variant="body1" color="#4CCEA9">Start Date</Typography></TableCell>
                  <TableCell><Typography variant="body1" color="#4CCEA9">End Date</Typography></TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                {tasks.map((task) => (
                  <TableRow key={task.id}>
                    <TableCell><Typography variant="body1" color="#4CCEA9">{task.task_name}</Typography></TableCell>
                    <TableCell><Typography variant="body1" color="#4CCEA9">{task.start_date}</Typography></TableCell>
                    <TableCell><Typography variant="body1" color="#4CCEA9">{task.end_date}</Typography></TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
