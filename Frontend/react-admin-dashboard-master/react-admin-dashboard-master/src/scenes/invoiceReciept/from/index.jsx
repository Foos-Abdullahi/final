...
//   const fetchProjectBudgetRemain = async (projectId) => {
//     try {
...
//   const sendForm = async () => {    
//     const budgetRemain = await fetchProjectBudgetRemain(selectproject);
    
//     if (budgetRemain === null) {
//       setSnackbarMessage("Error fetching project budget details.");
//       setSnackbarOpen(true);
//       return;
//     }

//     if (budgetRemain <= 0) {
//       setSnackbarMessage("Cannot add payment. Budget remaining is zero.");
//       setSnackbarOpen(true);
//       return;
//     }
...
//   return (
//     <Box m="20px">
//       <Header title="CREATE Invoice Receipt" subtitle="Create a New Invoice" />
//       <Snackbar
//         open={snackbarOpen}
//         autoHideDuration={6000}
//         onClose={() => setSnackbarOpen(false)}
