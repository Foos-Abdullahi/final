...
//       const uploadedFile = data.document; // Access the uploaded file
//       setDocument(uploadedFile.name);
//     console.log(document); // Set the document name to display

//     const reader = new FileReader();

//     // Callback function when file reading is completed
//     reader.onloadend = () => {
//       // Set document state to the read data
//       setDocumentContent(reader.result); // Store the content of the document
//     };
...
// //     try {
// //       const response = await fetch(`https://github.com/Foos-Abdullahi/final/blob/main/${fileName}`);
// //       if (!response.ok) {
